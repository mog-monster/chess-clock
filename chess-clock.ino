...
void pausedTimers(){
  Serial.print("MilliSeconds pausedStart: ");
  ...
  if(doAddition){
    ...
    Serial.print("doing addition gives: ");
    Serial.println(totalMilliSeconds);
  }
  else{
    totalMilliSeconds = baseMilliSeconds - halfMinuteAdd - decaMinuteAdd;
    Serial.print("doing subtraction gives: ");
    Serial.println(totalMilliSeconds);
  }
  if(totalMilliSeconds > 59949999){
    totalMilliSeconds = 59949999;
    Serial.print("after capping: ");
    Serial.println(totalMilliSeconds);
  }
  if(totalMilliSeconds < 1){
    totalMilliSeconds = 1;
    Serial.print("after curbing: ");
    Serial.println(totalMilliSeconds);
  }
